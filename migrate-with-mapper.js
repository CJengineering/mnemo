...
async function initializeMapper() {
  try {
    // Try to import the TypeScript mapper module
    const { createRequire } = require('module');
    const require_ts = createRequire(import.meta.url || __filename);

    // You might need to compile the TypeScript first or use ts-node
...
module.exports = { migratePostsWithMapper };
