...
// --- Hooks ---
import { useMobile } from 'app/page-editor/@/hooks/use-mobile';
import { useWindowSize } from 'app/page-editor/@/hooks/use-window-size';
...
import {
  handleImageUpload,
  MAX_FILE_SIZE
} from 'app/page-editor/@/lib/tiptap-utils';
